...
python app.py --loss_lambda ${loss_lambda} --dim 2 --cond_dim ${cond_dim} --save_path ${save_path} --seed ${seed} --log_normalization ${log_normalization} --dataset ${dataset} --mode train --model ${model} --samplingsteps -1 --batch_size 32 --total_epochs 150 --n_samples 1 --per_step 1 --sigma_time ${sigma_time} --sigma_loc ${sigma_loc}
